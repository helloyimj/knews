...
var datePickerController = (function datePickerController() {
    ...
    var localeDefaults = {
        ...
        titles:    ["Previous month","Next month","Previous year","Next year", "Today", "달력 보기", "wk", "Week [[%0%]] of [[%1%]]", "Week", "Select a date", "Click \u0026 Drag to move", "Display \u201C[[%0%]]\u201D first", "Go to Today\u2019s date", "Disabled date :"],
        rtl:       false,
        firstDayOfWeek:0,
        imported:  false
    };
    ...
    var destroy = function(e) {
        ...
        removeEvent(window, 'pagehide', datePickerController.destroy);
    };
    ...
    addEvent(window, 'pagehide', destroy);
