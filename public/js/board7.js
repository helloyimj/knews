...
//	})
	...
	$(document).on('click', '.listViewType button', function(){
		...
		location.href = "/kotranews/cms/com/index.do?MENU_ID=290&CONTENTS_NO=1&viewType=" + viewType + "&"+$("#sendForm").serialize();
	});
...
// 		window.open("/kotranews/cms/news/actionKotraBoardDownDetail.do?MENU_ID=290&pNttSn=" + nttSn + "&bbsSn=" + bbsSn + "&type=" + type);
		var src = "/kotranews/cms/news/actionKotraBoardDownDetail.do?MENU_ID=290&pNttSn=" + nttSn + "&bbsSn=" + bbsSn;
