    ...
    ***************************************************************************** */
            ...
            return function(A) {
                return function(e) {
                    ...
                    for (; o; )
                        try {
                            if (n = 1,
                            B && (s = 2 & e[0] ? B.return : e[0] ? B.throw || ((s = B.return) && s.call(B),
                            0) : B.next) && !(s = s.call(B, e[1])).done)
                                return s;
                            switch (B = 0,
                            s && (e = [2 & e[0], s.value]),
                            e[0]) {
    ...
    function w(A, e, t, r, n) {
        ...
        if (-1 !== Z.indexOf(c) && i === D || -1 !== Z.indexOf(i) && c === D)
            return Y;
        if (i === M && -1 !== [X, P, x].indexOf(c) || -1 !== [X, P, x].indexOf(i) && c === b)
            return Y;
        if (-1 !== Z.indexOf(i) && -1 !== AA.indexOf(c) || -1 !== AA.indexOf(i) && -1 !== Z.indexOf(c))
            return Y;
        if (-1 !== [M, b].indexOf(i) && (c === D || -1 !== [O, f].indexOf(c) && e[1 + o] === D) || -1 !== [O, f].indexOf(i) && c === D || i === D && -1 !== [D, y, v].indexOf(c))
            return Y;
        ...
        if (J === i && -1 !== [J, G, V, z].indexOf(c) || -1 !== [G, V].indexOf(i) && -1 !== [G, k].indexOf(c) || -1 !== [k, z].indexOf(i) && c === k)
            return Y;
        if (-1 !== tA.indexOf(i) && -1 !== [R, b].indexOf(c) || -1 !== tA.indexOf(c) && i === M)
            return Y;
    ...
    function u(t, A) {
        ...
        var e = function(A, n) {
            ...
            return A.forEach(function(A, e) {
                ...
                if (4 !== t && 11 !== t)
                    return s.push(e),
                    31 === t ? B.push("strict" === n ? L : X) : t === W ? B.push(_) : 29 === t ? B.push(_) : 43 === t ? 131072 <= A && A <= 196605 || 196608 <= A && A <= 262141 ? B.push(X) : B.push(_) : void B.push(t);
                if (0 === e)
                    return s.push(e),
                    B.push(_);
                var r = B[e - 1];
    ...
    var i, U, E, F, h, H = 10, d = 13, f = 15, p = 17, N = 18, m = 19, R = 20, L = 21, O = 22, v = 24, D = 25, b = 26, M = 27, y = 28, _ = 30, P = 32, x = 33, V = 34, z = 35, X = 37, J = 38, G = 39, k = 40, W = 42, Y = "×", q = (i = function(A) {
    ...
    E = Array.isArray(i) ? function(A) {
        for (var e = A.length, t = [], r = 0; r < e; r += 2)
            t.push(A[r + 1] << 8 | A[r]);
        return t
    }(i) : new Uint16Array(i),
    F = B(E, 12, U[4] / 2),
    h = 2 === U[5] ? B(E, (24 + U[4]) / 2) : function(A, e, t) {
        return A.slice ? A.slice(e, t) : new Uint32Array(Array.prototype.slice.call(A, e, t))
    }(U, Math.ceil((24 + U[4]) / 4)),
    new s(U[0],U[1],U[2],U[3],F,h)), Z = [_, 36], j = [1, 2, 3, 5], $ = [H, 8], AA = [M, b], eA = j.concat($), tA = [J, G, k, V, z], rA = [f, d], nA = (BA.prototype.slice = function() {
    ...
    yA.prototype.consumeToken = function() {
        ...
        bA) : iA(A) ? (this.reconsumeCodePoint(A),
    ...
    yA.prototype.consumeStringToken = function(A) {
        for (var e = "", t = 0; ; ) {
            ...
            if (92 === r) {
                ...
                t = -1,
                this._value.shift()) : uA(r, n) && (e += this.consumeStringSlice(t),
        ...
        return WA(A).forEach(function(A, e) {
            if (0 === e) {
                ...
                if (t.type === sA.IDENT_TOKEN && -1 !== ["top", "left", "right", "bottom"].indexOf(t.value))
                    return void (n = Ae(A));
                if ($A(t))
                    return void (n = (ce(t) + Qe(270)) % Qe(360))
            }
            var r = de(A);
            B.push(r)
        }),
        ...
        return new Promise(function(e, t) {
            ...
            if (n.onload = function() {
                if (200 === n.status)
                    ...
                    t("Failed to proxy resource " + i + " with status code " + n.status)
            }
            ,
            n.onerror = t,
        ...
        return WA(A).forEach(function(A, e) {
            ...
            if (0 === e ? t = A.reduce(function(A, e) {
                ...
                if (zA(e))
                    ...
                    case tt:
                    case Ze:
                        return B = Bt.CLOSEST_SIDE,
                        !1;
                    case je:
                        return B = Bt.FARTHEST_SIDE,
                        !1;
                    case $e:
                        return B = Bt.CLOSEST_CORNER,
                        !1;
                    case "cover":
                    case At:
                        return B = Bt.FARTHEST_CORNER,
                        !1
                    }
                else if (YA(e) || qA(e))
    ...
    var ot = function(A) {
        if (A.type === sA.URL_TOKEN) {
            ...
            return Se.getInstance().addImage(A.value),
            e
        }
        if (A.type !== sA.FUNCTION)
                    ...
                    t = A.reduce(function(A, e) {
                        if (r)
                            ...
                            case "at":
                                return !(r = !0);
                            case Ze:
                                return s = Bt.CLOSEST_SIDE,
                                !1;
                            case "cover":
                            case je:
                                return s = Bt.FARTHEST_SIDE,
                                !1;
                            case tt:
                            case $e:
                                return s = Bt.CLOSEST_CORNER,
                                !1;
                            case At:
                                return s = Bt.FARTHEST_CORNER,
                                !1
                            }
                        else if (YA(e) || qA(e))
    ...
    var Dt, bt, St = Ot("top"), Mt = Ot("right"), yt = Ot("bottom"), _t = Ot("left"), Pt = vt("top"), xt = vt("right"), Vt = vt("bottom"), zt = vt("left"), Xt = {
        name: "color",
        initialValue: "transparent",
        prefix: !1,
        type: Ce.TYPE_VALUE,
        ...
        parse: function(A) {
            return 1 === A.length && JA(A[0], "none") ? [] : WA(A).map(function(A) {
                for (var e = {
                    ...
                    var n = A[r];
                    YA(n) ? (0 === t ? e.offsetX = n : 1 === t ? e.offsetY = n : e.blur = n,
                    t++) : e.color = we(n)
                }
                return e
            })
        ...
        parse: function(A) {
            return 1 === A.length && JA(A[0], "none") ? [] : WA(A).map(function(A) {
                for (var e = {
                    ...
                    var n = A[r];
                    JA(n, "inset") ? e.inset = !0 : YA(n) ? (0 === t ? e.offsetX = n : 1 === t ? e.offsetY = n : 2 === t ? e.blur = n : e.spread = n,
                    t++) : e.color = we(n)
                }
                return e
            })
    ...
    var cn, Qn = function(A) {
        this.content = un(tn, A.content),
        this.quotes = un(Bn, A.quotes)
    }, wn = function(A) {
    ...
    var yn, _n = [{
        ...
        flags: 0,
        number: 50
    }], xn = "checkbox", Vn = "radio", zn = "password", Xn = 707406591, Jn = (A(Gn, yn = Un),
    Gn);
    function Gn(A) {
        ...
        e.type !== xn && e.type !== Vn || (e.styles.backgroundColor = 3739148031,
    ...
    var nB = ["OL", "UL", "MENU"]
      , BB = function(A, e, t) {
        for (var r = A.firstChild, n = void 0; r; r = n)
            if (n = r.nextSibling,
            cB(r) && 0 < r.data.trim().length)
                e.textNodes.push(new hn(r,e.styles));
            else if (QB(r)) {
                var B = sB(r);
                B.styles.isVisible() && (iB(r, B, t) ? B.flags |= 4 : aB(B.styles) && (B.flags |= 2),
    ...
    function RB(A, e, t, r, n, B) {
        if (A < -9999 || 9999 < A)
            return yB(A, tr.CJK_DECIMAL, 0 < n.length);
        var s = Math.abs(A)
          , o = n;
        if (0 === s)
            return e[0] + o;
        for (var i = 0; 0 < s && i <= 4; i++) {
            var a = s % 10;
            0 == a && $r(B, 1) && "" !== o ? o = e[a] + o : 1 < a || 1 == a && 0 === i || 1 == a && 1 === i && $r(B, 2) || 1 == a && 1 === i && $r(B, 4) && 100 < A || 1 == a && 1 < i && $r(B, 8) ? o = e[a] + (0 < i ? t[i - 1] : "") + o : 1 == a && 0 < i && (o = t[i - 1] + o),
            s = Math.floor(s / 10)
        }
        return (A < 0 ? r : "") + o
    }
          ...
          , i = JB(r).then(function() {
            return a(e, void 0, void 0, function() {
                ...
                return S(this, function(A) {
                    switch (A.label) {
                    case 0:
                        return this.scrolledElements.forEach(YB),
                        ...
                        void 0 === this.clonedReferenceElement ? [2, Promise.reject("Error finding the " + this.referenceElement.nodeName + " in the cloned document")] : o.fonts && o.fonts.ready ? [4, o.fonts.ready] : [3, 2];
                    case 1:
                        A.sent(),
                        A.label = 2;
                    case 2:
    ...
    xB.prototype.createElementClone = function(A) {
        ...
        var e = A.cloneNode(!1);
        return hB(e) && "lazy" === e.loading && (e.loading = "eager"),
        e
    }
    ,
    ...
    xB.prototype.cloneNode = function(A) {
        ...
        if (e && QB(A) && (wB(A) || uB(A))) {
            ...
            this.referenceElement === A && wB(t) && (this.clonedReferenceElement = t),
            EB(t) && $B(t);
            for (var s = this.counters.parse(new wn(r)), o = this.resolvePseudoContent(A, t, n, LB.BEFORE), i = A.firstChild; i; i = i.nextSibling)
                QB(i) && ("SCRIPT" === i.tagName || i.hasAttribute(_B) || "function" == typeof this.options.ignoreElements && this.options.ignoreElements(i)) || this.options.copyStyles && QB(i) && rB(i) || t.appendChild(this.cloneNode(i));
    ...
    xB.prototype.resolvePseudoContent = function(U, A, e, t) {
        ...
        if (e) {
            ...
            if (C && r && "none" !== r && "-moz-alt-content" !== r && "none" !== e.display) {
                ...
                return uB(A) ? A.className.baseValue += n : A.className += n,
                E
            }
        }
    }
    ...
    var VB, zB, XB = function(A, e) {
        ...
        e.scrollLeft = t,
        e.scrollTop = r
    }, qB = "___html2canvas___pseudoelement_before", ZB = "___html2canvas___pseudoelement_after", jB = '{\n    content: "" !important;\n    display: none !important;\n}', $B = function(A) {
        As(A, "." + qB + ":before" + jB + "\n         ." + ZB + ":after" + jB)
    }, As = function(A, e) {
    ...
    var is, as, cs = function(A) {
        ...
        this.topLeftPaddingBox = 0 < n || 0 < B ? us(t.left + p, t.top + H, Math.max(0, n - p), Math.max(0, B - H), is.TOP_LEFT) : new ts(t.left + p,t.top + H),
        this.topRightPaddingBox = 0 < o || 0 < i ? us(t.left + Math.min(g, t.width + p), t.top + H, g > t.width + d ? 0 : o - d, i - H, is.TOP_RIGHT) : new ts(t.left + t.width - d,t.top + H),
        ...
        this.topLeftContentBox = 0 < n || 0 < B ? us(t.left + p + T, t.top + H + N, Math.max(0, n - (p + T)), Math.max(0, B - (H + N)), is.TOP_LEFT) : new ts(t.left + p + T,t.top + H + N),
    ...
    function Fs(A, e) {
        ...
        if (A.styles.overflowX !== sr.VISIBLE) {
            var B = Qs(this.curves)
              , s = ws(this.curves);
            es(B, s) ? this.effects.push(new ls(B,6)) : (this.effects.push(new ls(B,2)),
    ...
    var Ns = function(c, Q, w, u) {
            ...
            if (e || t) {
                ...
                if (A.styles.isPositioned() || A.styles.opacity < 1 || A.styles.isTransformed()) {
                    ...
                    if (o < 0) {
                        ...
                        B.zeroOrAutoZIndexOrTransformedOrOpacity.push(s)
                } else
                    A.styles.isFloating() ? B.nonPositionedFloats.push(s) : B.nonPositionedInlineLevel.push(s);
                Ns(r, s, e ? s : w, n)
            } else
      ...
      , Is = function(A, e, t, r) {
        var n = [];
        return os(A) ? n.push(A.subdivide(.5, !1)) : n.push(A),
        os(t) ? n.push(t.subdivide(.5, !0)) : n.push(t),
        os(r) ? n.push(r.subdivide(.5, !0).reverse()) : n.push(r),
        os(e) ? n.push(e.subdivide(.5, !1).reverse()) : n.push(e),
        n
    }
      , Ts = function(A, e, t) {
        var r = e[0]
        ...
        return a(this, void 0, void 0, function() {
            ...
            return S(this, function(A) {
                ...
                case 7:
                    ...
                    [3, 8];
                case 8:
                    if (e instanceof In && this.renderReplacedElement(e, t, e.canvas),
                    !(e instanceof Rn))
                        return [3, 12];
                    A.label = 9;
                case 9:
                ...
                case 13:
                    ...
                    A.label = 14;
                case 14:
                    if (e instanceof Jn && (i = Math.min(e.bounds.width, e.bounds.height),
                    e.type === xn ? e.checked && (this.ctx.save(),
                    ...
                    this.ctx.fill(),
                    this.ctx.restore()) : e.type === Vn && e.checked && (this.ctx.save(),
                    this.ctx.beginPath(),
                    ...
                    e = function(e) {
                        ...
                        return S(this, function(A) {
                            ...
                            case 3:
                                ...
                                [3, 4];
                            case 4:
                                return t && (n = ds(b, v, [t.width, t.height, t.width / t.height]),
                                g = n[0],
                                f = n[1],
                                p = n[2],
                                h = n[3],
                            ...
                            case 5:
                                ...
                                N = function(A, e, t, r, n) {
                                    ...
                                    case Bt.CLOSEST_SIDE:
                                        A.shape === rt.CIRCLE ? B = s = Math.min(Math.abs(e), Math.abs(e - r), Math.abs(t), Math.abs(t - n)) : A.shape === rt.ELLIPSE && (B = Math.min(Math.abs(e), Math.abs(e - r)),
                                        s = Math.min(Math.abs(t), Math.abs(t - n)));
                                        break;
                                    case Bt.CLOSEST_CORNER:
                                        if (A.shape === rt.CIRCLE)
                                            B = s = Math.min(Ne(e, t), Ne(e, t - n), Ne(e - r, t), Ne(e - r, t - n));
                                    ...
                                    case Bt.FARTHEST_SIDE:
                                        A.shape === rt.CIRCLE ? B = s = Math.max(Math.abs(e), Math.abs(e - r), Math.abs(t), Math.abs(t - n)) : A.shape === rt.ELLIPSE && (B = Math.max(Math.abs(e), Math.abs(e - r)),
                                        s = Math.max(Math.abs(t), Math.abs(t - n)));
                                        break;
                                    case Bt.FARTHEST_CORNER:
                                        if (A.shape === rt.CIRCLE)
                                            B = s = Math.max(Ne(e, t), Ne(e, t - n), Ne(e - r, t), Ne(e - r, t - n));
                                        else if (A.shape === rt.ELLIPSE) {
                                    ...
                                    return Array.isArray(A.size) && (B = ae(A.size[0], r),
                                    s = 2 === A.size.length ? ae(A.size[1], n) : B),
                                    [B, s]
                                }(e, f, p, h, H),
                                K = N[0],
                                I = N[1],
                                ...
                                D.path(g),
                                D.ctx.fillStyle = T,
                                K !== I ? (m = b.bounds.left + .5 * b.bounds.width,
                                R = b.bounds.top + .5 * b.bounds.height,
                                O = 1 / (L = I / K),
                                D.ctx.save(),
                                D.ctx.translate(m, R),
                                ...
                                D.ctx.restore()) : D.ctx.fill())) : (B = ds(b, v, [null, null, null]),
                                g = B[0],
                                f = B[1],
                                p = B[2],
                                h = B[3],
                                ...
                                u.fillStyle = U,
                                u.fillRect(0, 0, h, H),
                                0 < h && 0 < H && (l = D.ctx.createPattern(w, "repeat"),
                                D.renderRepeat(g, l, f, p))),
                                A.label = 6;
                            case 6:
                                return v--,
        ...
        return a(void 0, void 0, void 0, function() {
            ...
            return S(this, function(A) {
                ...
                case 4:
                    ...
                    A.label = 5;
                case 5:
                    return !0 === Q.removeContainer && (PB.destroy(l) || De.getInstance(r).error("Cannot detach cloned iframe as it is not in the DOM anymore")),
